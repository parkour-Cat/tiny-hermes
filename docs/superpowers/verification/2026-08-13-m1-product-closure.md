...
| 13 | Run §24.1 on the Linux reference shape (8 vCPU, 16 GiB, 50 ms delay, image cached, 100k RunEvents) | `scripts/benchmark_m1.py`; unit pins in `packages/backend/tests/unit/scripts/test_benchmark_m1.py`; host shape: `2026-08-14-m1-reference-host.md`; live runs: `2026-08-14-m1-benchmark-live.md`, `2026-08-14-m1-benchmark-live-2.md`, `2026-08-14-m1-benchmark-live-3.md` | **not a pass.** 8 vCPU / ≈30.47 GiB. Run 2+3 inside cells: create_run, run_event, sandbox_cold, **sandbox_warm p95 27.6ms**, workspace_*, next_run, service_recovery 6.51s. Still out: SSE 5s cadence at 500 connections (11–13s poll gaps); worker_recovery 31.3–31.6s / 30s (lease=gate). Do not edit thresholds. |
