...
| 13 | Run §24.1 on the Linux reference shape (8 vCPU, 16 GiB, 50 ms delay, image cached, 100k RunEvents) | `scripts/benchmark_m1.py`; unit pins in `packages/backend/tests/unit/scripts/test_benchmark_m1.py`; host shape: `2026-08-14-m1-reference-host.md`; live runs: `2026-08-14-m1-benchmark-live.md`, `2026-08-14-m1-benchmark-live-2.md`, `2026-08-14-m1-benchmark-live-3.md`, `2026-08-14-m1-benchmark-live-4.md` | **official script `passed: true`** on run 4 (8 vCPU / ≈30.47 GiB, exit 0, no threshold edits). Ten cells measured. Not `0.1 Technical Preview`; not CI green. |
...
**not** mark `0.1 Technical Preview`. The Linux reference host has now
run the official benchmark (`2026-08-14-m1-benchmark-live-4.md`,
`passed: true`); flipping the public phrase is a separate product mark.
